      ...
      {Array.isArray(products) &&
        products?.map((product) => (
          ...
          >
            ...
            <div className="col w-full h-full flex items-center justify-center min-[500px]:text-[16px]  text-[14px] ms-16">
              <div className="div flex flex-col items-start font-bold">
                <span className="flex items-center gap-1">
                  {" "}
                  {product.stock}{" "}
                  <span className="min-[1200px]:flex hidden">item left</span>
                </span>
