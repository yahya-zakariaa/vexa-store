...
export default function page() {
  ...
  return (
    <section className="signup ">
      <div className="container w-[90%] md:w-[50%] lg:w-[50%] mx-auto  min-h-screen pb-10 pt-16 md:pt-20 ">
        <form
          onSubmit={formik.handleSubmit}
          className="form mt-10 w-full md:w-[90%] lg:w-[65%] mx-auto"
        >
          <div className="header mb-5 ">
            <h2 className="text-center text-[1.7rem] md:text-[2rem] font-bold mb-1  tracking-wide text-white">
              Create Account
            </h2>
          </div>
          <div className="form-group flex flex-col w-full mx-auto my-4 gap-1">
            <label
              htmlFor="name"
          ...
          <div className="form-group flex flex-col w-full mx-auto my-4 gap-1">
            ...
            <input
              ...
              className="input bg-[#414141] bg-opacity-50  text-white placeholder:text-[#d4d4d4b7] focus:border-[#ccc] focus:bg-[#414141] duration-300 outline-none border border-[#7e7e7e8c] px-3 py-2 rounded-md w-full"
            />
          ...
          <div className="form-group relative flex flex-col w-full mx-auto my-4 gap-1">
            <label
              htmlFor="password"
              className="label text-md font-medium text-white "
            >
            ...
            <div className="relative">
              ...
              <span
                ...
                className="text-[#fff] text-xs absolute right-4 bottom-[9px]"
              >
                {activePassword ? (
                  <svg
          ...
          <div className="form-group flex md:flex-row flex-col md:items-center items-start md:gap-8 gap-3 mt-10  w-full">
            ...
            <span className="text-start text-[1rem] md:text-[20px] tracking-wide  text-[#ffffffd5]">
              Already have Account?{" "}
              <Link href="/account/login" className="text-[#fff] ms-1 tracking-wide">
                Login
              </Link>
            </span>
          </div>
